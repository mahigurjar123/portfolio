    ...
    return (
        <div className="flex justify-center mt-10">
            <div className="rounded-2xl shadow-lg p-8 bg-white max-w-sm">
                ...
                <p className="text-center text-gray-600 mb-6">Flutter Developer</p>
                ...
                <div className="flex justify-center space-x-4 text-gray-600">
                    <a href="https://github.com/MahendraGurjar" target="_blank" rel="noreferrer">
                        <FaGithub className="w-6 h-6 hover:text-black hover:scale-110 transition-transform duration-300" />
                    </a>
                    <a href="https://www.linkedin.com/in/mahendra-gurjar/" target="_blank" rel="noreferrer">
                        <FaLinkedin className="w-6 h-6 hover:text-blue-700 hover:scale-110 transition-transform duration-300" />
                    </a>
                    <a href="https://www.instagram.com/mahendra_gurjar/" target="_blank" rel="noreferrer">
