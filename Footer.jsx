    ...
    return (
        <footer className="bg-zinc-900 py-12">
            <div className="container mx-auto px-6 lg:flex lg:justify-between lg:items-start">
                <div className="lg:w-1/3 mb-8 lg:mb-0">
                    ...
                    <div className="flex space-x-6">
                        <a href="https://github.com/MahendraGurjar" target="_blank" rel="noopener noreferrer" className="group">
                        ...
                        <a href="https://www.linkedin.com/in/mahendra-gurjar/" target="_blank" rel="noopener noreferrer" className="group">
                        ...
                        <a href="https://www.instagram.com/mahendra_gurjar/" target="_blank" rel="noopener noreferrer" className="group">
                ...
                <div className="lg:w-1/3 text-zinc-400 text-center lg:text-right">
                    <p className="mb-2">Email: mgurjar051099@gmail.com</p>
                    <p className="mb-6">Phone: +91 99937 22900</p>
            ...
            <div className="mt-12 border-t border-zinc-700 pt-6">
                <p className="text-center text-zinc-500">&copy; {new Date().getFullYear()} Mahendra Gurjar. All Rights Reserved.</p>
            </div>
        </footer>
    );
};
